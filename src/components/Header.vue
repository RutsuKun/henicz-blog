<template>
  <div>
    <nav class="bg-gray-800">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative flex items-center justify-between h-16">
          <div class="inset-y-0 flex items-center sm:hidden mr-2">
          ...
          <div class="flex-1 flex items-stretch justify-start">
            ...
            <div id="menu" class="hidden sm:block sm:ml-6">
            ...
            <div class="ml-3 relative">
              <div>
                <button
                  ...
                  class="relative z-10 bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                  id="user-menu"
                  aria-haspopup="true"
                >
              ...
              <div
                ...
                class="fixed w-full h-full bg-black opacity-50 left-0 top-0"
              ></div>
            </div>
          </div>
        </div>
      ...
      <div :class="{ hidden: !menuOpened }" class="sm:hidden" id="mobile-menu">
    ...
    <div class="bg-indigo-600 hidden">
          ...
          <div class="w-0 flex-1 flex items-center">
            ...
            <p class="ml-3 font-medium text-white truncate">
              ...
              <span class="hidden md:inline">
                Soon the site will be available to everyone.
              </span>
            </p>
          </div>
          <div
